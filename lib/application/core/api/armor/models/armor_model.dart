...
class Armor with _$Armor {
  factory Armor({
    ...
    @JsonKey(name: 'base_ac') required String baseAc,
    ...
    @JsonKey(name: 'ac_string') required int acString,
    @JsonKey(name: 'strength_requirement') required int? strengthRequirement,
    required String cost,
    required String weight,
    @JsonKey(name: 'stealth_disadvantage') required String stealtDisadvantage,
  }) = _Armor;
