...
abstract class $AsiCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, int value});
}
...
class _$AsiImpl implements _Asi {
  _$AsiImpl({required this.title, required this.value});
  ...
  @override
  String toString() {
    return 'Asi(title: $title, value: $value)';
  }
...
abstract class _Asi implements Asi {
  factory _Asi({required final String title, required final int value}) =
      _$AsiImpl;
